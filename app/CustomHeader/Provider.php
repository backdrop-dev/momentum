...
namespace Momentum\CustomHeader;
...
class Provider extends ServiceProvider {
	...
	public function register() {
		...
		$this->app->singleton( 'momentum/custom/header', App\CustomHeaders::class );

		// Register the Sidebar Component
		$this->app->singleton( App\Component::class, function() {
			return new App\Component( $this->app->resolve( 'momentum/custom/header' ) );
		});
	}
